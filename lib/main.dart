...
import 'package:uas_mobile_drmk/app_color.dart';
import 'package:uas_mobile_drmk/create_task_screen.dart';
import 'package:uas_mobile_drmk/widget_background.dart';
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text('Apa kamu yakin ingin menghapus ${task['name']}?'),
                                    actions: <Widget>[
                                      FlatButton(
                                        child: Text('Tidak'),
                                        onPressed: () {
